...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=636757812ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fillter&table=users">`fillter`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=utron&table=team">`utron`.`team`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=utron&table=pendaftaran">`utron`.`pendaftaran`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pendaftaran_utron&table=form">`pendaftaran_utron`.`form`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pendaftaran_utron&table=Form">`pendaftaran_utron`.`Form`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2a3c48464a603d437c5c5c746a25785d">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="fillter" targettable="users">
